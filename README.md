...
- `0.3.48` — **Mama Cassavir identity lock:** Cyborg hacker Controller (not human Rival Tactician artillery). Soft chrome sells the grandmother look; Wire kit + people; holdout is implant-weapon backup. Negotiation-first named boss, echelon 2. Rebuild `node tools/build-packs.mjs bestiary`.
