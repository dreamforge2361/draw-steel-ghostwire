...
| **Ghostwire Summons & Machines** (Actors) | `summons` | 12 | Support Entities §3.1 | Sprites (Technomancer) · Elementals & Companions, Pact Spirits, Drones & Vehicles, Wired Nodes (empty, later phases) |
