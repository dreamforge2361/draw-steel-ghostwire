#!/usr/bin/env node
/**
 * 0.3.85 — Corp & Security Connect-interface smoke.
...
/** Meat-only folder that must not pick up a kit from this pass (0.3.85: streets/humanoids are Wired). */
const MEAT_ONLY = ["reach-critters"];
