#!/usr/bin/env node
/**
 * 0.3.82 — Corp & Security Connect-interface smoke.
...
console.log("Corp & Security Wire-access smoke (0.3.82)\n");

ok(read("module.json").version === "0.3.82", `module.json is 0.3.82 (got ${read("module.json").version})`);
