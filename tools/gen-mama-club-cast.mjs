...
const itemId = (id, n) => `${id.slice(0, 12)}It${String(n).padStart(2, "0")}`;
const captainId = id => `${id.slice(0, 11)}Captn`;
...
function captainEffect(id) {
  const effect = clone(minionSpine.effects.find(e => e.name === "With Captain"));
...
const MELEE = { type: "melee", primary: "1", secondary: "1", tertiary: "1" };
const RANGED = { type: "ranged", primary: "1", secondary: "5", tertiary: "1" };
