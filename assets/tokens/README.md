...
|---|---|---|---|
| Crewed vehicles | `vehicles/<dsid>.webp` | `modules/draw-steel-ghostwire/assets/tokens/vehicles/<dsid>.webp` | B101 shipped **0.3.31** (32). **0.3.80:** AEQ Seal Cruiser / Writ VTOL + LAZ White Door / Crash Angel (`{png,webp}`) |
