...
## Megacorp Host styles (Twelve Conglomerates, 0.3.54 / 0.3.79)
...
Tickers locked: `docs/rulebook/MEGACORP-TICKERS.md`. AEQ/LAZ Host + brand plates shipped **0.3.79** (Michael). Brand marks: `assets/brands/megacorps/brand-aeq.{png,webp}` and `brand-laz.{png,webp}`. Do **not** regenerate plates.
