...
| machines/ | Drone & vehicle **scale-band Actor templates** plus named **Mule-Bot** / **Lane-Hopper** / **Star-Chopper** / **Bulldog** (Items stay in `vehicles` pack; Deploy / Recall in `scripts/machines.mjs`; map in `docs/masters/GHOSTWIRE_MACHINE_BANDS.md`) | 4 |
