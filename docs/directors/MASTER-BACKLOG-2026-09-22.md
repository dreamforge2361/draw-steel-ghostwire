...
**Next picks:** **I2 Chargen Wizard (0.3.101)** → **G4 B49 skill-on-weapon rolls** → **G3** lang + style tokens → **S1** → **L1** (locked queue) · DJ1 district journals · F2 ritual applet polish · S2 broader SR gear reskin (now unblocked).  
...
## Suggested next pick
**Queue locked 2026-09-22 (unless Michael redirects):** Chargen Wizard **I2 / 0.3.101** → **G4 B49 skill-on-weapon rolls** → **G3** lang + style tokens → **S1** → **L1**. G2 armor / gadget mod families shipped (**0.3.100**) and the **N4 PDF reprint is out** (0.4.0 @ 0.3.100, 316 pages — `docs/directors/n4-pdf-reprint-03100.md`). Michael Foundry smoke **PASS** on G2 (`g2-armor-gadget-mods-smoke-03100.md`) and G1 (`kit-grants-smoke-0399.md`). Still optional / deferred: `docs/directors/s8-machines-smoke-0398.md` (S8), `docs/directors/voidmark-director-only-smoke-0397.md` (S6 — already signed earlier).
**Next:** Ship Chargen Wizard first; then G4's locked B49 skill-on-weapon roll pass. Module is **0.3.100** until Chargen ships.
