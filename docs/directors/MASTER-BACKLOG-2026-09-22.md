...
**Module now:** **0.3.94** on main (0.3.93 Michael Foundry smoke **PASS** — Magical Societies lore, ¥250 pregens, F4 regen).  
**Just shipped:** F7 Magical Societies contact Actors — Edda Marr / Tavi Sorn / Daska Venn in Ghostwire Bestiary (0.3.94).  
**Next picks:** F8 Ritual Seal artifacts · F6 Director Pay/Spend macro · N4 Thursday PDF · DJ1 district journals · LR2 gangs.  
...
| F6 | **Director Pay / Spend Hero macro** | Macro (or sheet control) the Director runs to **credit** or **debit** a hero's `system.hero.wealth`. Amount + reason go to chat. Complements the Gear kiosk (player spend) with a Director-side purse tool for payouts, fees, bribes, job pay. |
...
| F8 | **Ritual Seal artifacts** | On Seal: create Ritual Effect (Working, Magnitude, Leader, expires, scope). Ward/Threshold → non-combat scene marker; Calling → existing summons path + stamp; Artifice → enchanted Item; Reach → AE/chat; Unmaking → usually no token. LOCKED design 2026-09-22. |
...
## Suggested next pick
**F7 shipped in 0.3.94** and is waiting on Michael's Foundry smoke. Next Foundry: **F8 Ritual Seal**, **F6 Pay/Spend macro**, or **N4 Thursday PDF**. Lore track: **LR2** gang deepeners; **DJ1** district player journals. Adventure: **A1 Quiet Floor** after Deadhead Saturday.
