...
- Venue: compatible Foundry world with **Ghostwire Build** enabled. World *Ghostwire - the Reach* / `ghostwire-v2` optional only.
...
- **Michael LOCK:** Draw Steel / MCDM / Creator License belong **only** in front matter. Appendix B is 100% Ghostwire + Foundry Hero-sheet steps — zero “Draw Steel” / “Heroes” / DS procedure citations.
