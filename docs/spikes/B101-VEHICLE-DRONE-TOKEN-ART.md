...
**Date:** 2026-09-19  
**Module:** **0.3.31**  
**Status:** **SHIPPED** — 36 drone + 32 vehicle WebPs; vehicles-pack `img` + LevelDB rebuilt. **0.3.68:** Mule-Bot cargo plate (PNG + 1024² WebP) also on generic **Drone (Medium)**. **0.3.75:** Mule-Bot Deploy path verified (`drone-medium` band; treasure SKU intentional). *Pending Michael Foundry-verify (Deploy from the Item).*  
