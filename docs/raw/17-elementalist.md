...
| **World-Fissure** | 9 | 9th level | Main Action | *See Heroic Abilities → 9-Cost Band above.* It is included in the 9-cost shared pool but Geomancers may take it before other subclasses (a class feature quirk). |
