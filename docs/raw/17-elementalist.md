...
- **Provisional Stamina (until Veil §C3):** a summoned elemental has **rank base + (Logic × level)** Stamina -- base 15 (Rank 1 and the signature companions) / 25 (Rank 2) / 35 (Rank 3) / 50 (Rank 4) / 65 (Rank 5). Summon Elemental binds up to **Rank 1 from 1st level, Rank 2 from 5th, Rank 3 from 7th**.
