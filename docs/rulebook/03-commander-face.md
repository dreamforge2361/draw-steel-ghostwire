# Ghostwire Core Rulebook — Chapter: The Commander / Face
...
**Notes for review:**
- Heroic resource: Influence (per-encounter)
- Subclasses: Street-Fixer / Corp-Exec / Bard (fully mundane — supersedes older Veil-touch Bard line)
- Dual-mode Mark (combat + social) is intentional new shape — verify in review
- Many 9/11-cost and doctrine abilities flagged invented/provisional in master
...
## Stage 2 review checklist (The Commander / Face)
