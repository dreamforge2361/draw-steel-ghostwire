...
- **B112** Scene → Wire auto-nodes — **SHIPPED 0.3.48, pending Foundry-verify**. Spike: `docs/spikes/B112-SCENE-WIRE-AUTO-NODES.md`. Console GM button; Light Control + Maglock from named lights / wall doors; B113 art hook only.
