...
Spec: `docs/spikes/B38b1-NAMED-LORE-BOSSES.md`. Five named level-bosses from the Lore Source, adapted from Draw Steel spines with full Director biographies (stratum, hook, holds, answers to / leans on, table use) and Draw Steel negotiation values: **Mama Cassavir** (Reach Streets; identity lock 2026-09-20 / 0.3.48: Cyborg hacker Controller, not Rival Tactician / Human Malice → L5 elite controller), **Warden Krael** (Corp & Security, Devil High Judge → L6 leader), **The Ferryman** (Reach Streets, Time Raider Tyrannis → L3 leader), **The Choirmother** (Reach Streets, High Elf Ordinator → L3 leader; Mid default, Early / Mid / Late (Fallen) dial in the Director bio), **Cael Marrow** (Wilds & Jungles, Wode Elf Warleader → L3 leader). Firearms / chrome doctrine applied; Human Malice on human-keyword bosses (Cassavir is cyborg as of 0.3.48 — no human malice); flags `decision: "Original"`, `role: "named-boss"`, `loreName`.
