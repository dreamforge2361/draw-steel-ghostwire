...
- **B116** Node token library — **SHIPPED 0.3.49, pending Foundry-verify**. Spike: `docs/spikes/B116-NODE-TOKEN-LIBRARY.md`. Catalog `assets/tokens/wired/library.json` (8 styles); Console Token art select; Auto Light/Maglock/Cam keep locked defaults.
