...
- **B104** Deadhead Foundry run pack — **SoR + empty pack scaffold 0.3.33**; **Gold Line map notes + Scene 0.3.36 (B106)**; **cargo remap folded 0.3.40**; **Director journal 0.3.42**. Spike: `docs/spikes/B104-DEADHEAD-FOUNDRY-RUN-PACK.md`. Director SoR `docs/directors/runs/deadhead/DEADHEAD-GOLD-LINE.md` + sidecar `GOLD-LINE-CARGO-REMAP.md` (LOCKED). JournalEntry pack `runs` (label **Ghostwire Runs**, GM-only) with intra-pack folder **Deadhead**. Director journal pages: Overview, Trace 1–12 + call-home, cargo consist L1–R3, Beats 0–5, Items, Opposition, Foundry checklist. Remaining: Mama Brief + ARG wafer as Gear items; hangout / canyon scenes (Mama reuse; Gold Line is Michael’s live Scene). No Trace −1 class abilities. Cargo maglev — not a passenger train. Do not overwrite Gold Line walls/lights/tiles.
