...
| **Bestiary originals Wave 2 (B38b)** | Port Reach Handbook Threats + Critters (Canopy-Stalker, Reach Behemoth, ICE, gang/corp blocks) + lore level-bosses. Wilds stay thin until Pandora-like pass. Spike: `docs/spikes/B38b-BESTIARY-ORIGINALS-WAVE2.md`. | **Backlog** |
