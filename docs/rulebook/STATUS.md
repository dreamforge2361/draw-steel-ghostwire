...
1. Stage 3 shared core / Stage 4 Wire–Veil–Machines.

## Next (Foundry) — see FOUNDRY-BUILD-PLAN.md

1. Finish spike **B1**: Pure Human signature (Detect the Supernatural) in the module.
2. Create dedicated Ghostwire test world (**C0**); verify B1 in Foundry.
3. Then either Pure Human full 3 AP menu (**B2**) or Stage 3 shared core text.
