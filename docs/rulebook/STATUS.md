...
| **Reach Handbook Journals (B45)** | Ossian Reach Handbook → lore/map Journals + art preserve. Path on disk (em-dash filename). Stub: `docs/directors\reach-handbook-journals.md`. | **Backlog** |
