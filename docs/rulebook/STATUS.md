...
| **Equipment → use abilities (B49)** | Bug: gear `treasure` (e.g. Chatterbox) on a Hero does not grant a fire/use ability, so sheet attacks and B40 SFX never attach to the gun. Stub: `docs/directors/equipment-use-abilities.md`. | **Backlog** |
