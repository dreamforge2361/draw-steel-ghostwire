...
| **Bestiary originals Wave 2 (B38b)** | Port Reach Handbook Threats + Critters (Canopy-Stalker, Reach Behemoth, ICE, gang/corp blocks) + lore level-bosses. Wilds stay thin until Pandora-like pass. Spike: `docs/spikes/B38b-BESTIARY-ORIGINALS-WAVE2.md`. | **Wave 2a built (v0.1.52), pending Foundry verify** — 10 street/corp threats, 5 Reach Critters, Canopy-Stalker + Reach Behemoth, 3 ICE; lore level-bosses (2a.1) and Wave 2b backlog |
