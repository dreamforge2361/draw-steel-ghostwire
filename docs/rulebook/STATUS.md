...
| **Director Run Generator (B39)** | ApplicationV2 popup like Wired Console: dial level/echelon/run type/stratum; randomize pay, data value, challenges, recommended NPCs/adversaries; create mission Journal for pinch runs. Design + as-built notes: `docs/directors/run-generator.md`. | **v1 implemented (v0.1.54), pending Foundry verify** (2026-09-17) — Token controls › Run Generator (Directors only); 9 run types × 8 strata × 4 heat × Wired intensity; seeded; opposition from the live bestiary; Create Journal in Ghostwire Runs |
...
| **Pregen Heroes (B44)** | Dossiers & Fiction PDF → 8 Hero Actors + story Journals + art. Stub: `docs/directors/pregens-dossiers.md`. | **Backlog** |
