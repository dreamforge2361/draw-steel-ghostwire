...
| **Reach Random Encounters (B48)** | Foundry RollTables for Hive / City / Wild events (flavor, RP hooks, occasional action/combat). Stub: `docs/directors/random-encounter-tables.md`. | **Backlog** |
