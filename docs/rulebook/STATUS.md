...
| **Pregen Heroes (B44)** | Dossiers & Fiction PDF → 8 Hero Actors + story Journals + art. Stub: `docs/directors/pregens-dossiers.md`. | **Built 0.1.62 (B44), pending Michael Foundry-verify** — 8 Level 1 Hero Actors in `pregens` + 8 origin stories in `pregen-fiction`, portraits extracted from the PDF to `assets/pregens/`. Roster: `docs/masters/pregens/ROSTER.md`; assumptions: `BUILD-NOTES.md`. |
