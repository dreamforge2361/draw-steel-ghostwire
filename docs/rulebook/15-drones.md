...
> **Tone:** Reach-native chrome in the rain — LED strips, scarred housings, neon reflected on wet rotor blades — not clean white-box miltech.
...
|---|---|
| **Active drones** | **Max 1** active at a time |
| **Jump-In** | **Forbidden** |
...
**Intent:** a Scout's eye-in-the-sky or a Medic's trauma mule is supported; a second Operator does not become a discount Wrench.
...
**Chassis → mod slots (doctrine):** slots climb with Availability / Echelon (same shape as Gear master). Micro/Street ≈ 1; Professional ≈ 2; Restricted ≈ 3; Military ≈ 4; Prototype ≈ 5. A chassis cannot exceed its published slot count — buy a bigger frame for more capacity.

---

## 5. Full drone inventory

**Reading the table:** slang / corp / sci names are **Ghostwire-original**. Prices climb with Availability + Echelon. Concrete Integrity / Speed / Armor numbers deferred to the shared Machines numeric pass — profiles stay qualitative here. Mounted weapons come from Category 3; installs are §Craft Projects (`14-mods.md`).

### 5.1 Inventory (25 chassis)

| Name (slang / corp / sci) | Domain | Scale | Echelon | Availability | Cost ¥ | Mod slots | Profile | Tags |
|---|---|---|---|---|---|---|---|---|
| Fly / Micro-Drone / insect-scale recon mote | Air (drone) | Personal | 1 | Street | 200 | 1 | Palm spy — vents, perches, live video relay. | Recon, Expendable, Wired |
| Skitter / Vent-Rat / crawl-mote chassis | Ground (drone) | Personal | 1 | Street | 280 | 1 | Magnetic belly + whisker cams; lives in cable trays. | Recon, Climb, Wired |
| Needle / Pin-Eye / kamikaze microframe | Air (drone) | Personal | 1 | Street | 350 | 1 | One-shot buzz or bang; cheap swarm filler. | Recon, Kamikaze, Expendable |
| Buzz / Ad-Moth / decoy holomote | Air (drone) | Personal | 1 | Street | 400 | 1 | Throws false AR / heat chirps; dies if shot. | EW, Decoy, Wired |
| Taser-Bee / Shock-Mote / contact stunner | Air (drone) | Personal | 1 | Professional | 750 | 2 | Close shock payload; soft takedown favorite. | Nonlethal, Swarm, Wired |
| Crawler / Recon Drone / quadruped sensor unit | Ground (drone) | Light | 1 | Professional | 800 | 2 | Climbs, maps, plants taps — forward sensor for Scout/Hacker. | Recon, Climb, Wired |
| Rotor / Quad-Drone / aerial recon quadcopter | Air (drone) | Light | 1 | Professional | 900 | 2 | Default eye-in-the-sky; overwatch, cheap swarm body. | Recon, Swarm, Wired |
| Spotter / Mark-Eye / designator quad | Air (drone) | Light | 1 | Professional | 1,100 | 2 | Paints targets for crew fire; poor brawler. | Recon, Mark, Wired |
| Mule-Bot / Cargo Drone / autonomous hauler | Ground (drone) | Vehicle (drone) | 1 | Professional | 1,100 | 2 | Hauls kits, extracts wounded, blocks a corridor. | Cargo, Cover, Wired |
| Wrenchbot / Repair Drone / field maintenance unit | Ground (drone) | Light | 2 | Restricted | 3,000 | 3 | Mobile toolkit — feeds Field Repair / rearm loops. | Repair, Support, Wired |
| Guard-Dog / Patrol Drone / autonomous sentry | Ground (drone) | Light | 2 | Restricted | 3,200 | 3 | Perimeter walk: light mount, motion net, area denial. | Sentry, Mount, Wired |
| Medbot / Trauma Drone / field-medic unit | Ground (drone) | Light | 2 | Restricted | 3,500 | 3 | Runs a stabilize package to a downed ally under fire. | Medic, Support, Wired |
| Choir-Box / Spoof-Drone / local EW kite | Air (drone) | Light | 2 | Restricted | 3,600 | 3 | Jam / spoof bubble for a room or alley mouth. | EW, Wired |
| Nest / Hardpoint Sentry / deployable turret-drone | Ground (drone) | Light | 2 | Restricted | 3,800 | 3 | Drops, braces, becomes a temporary autogun nest. | Sentry, Mount, Wired |
| Barracuda / Aquadrone / submersible saboteur | Water (drone) | Light | 2 | Restricted | 4,000 | 3 | Silent wet recon; plants charges on hulls and intakes. | Aquatic, Sabotage, Wired |
| Ghost-Courier / Shade-Mule / low-obs cargo kite | Air (drone) | Light | 2 | Restricted | 4,500 | 3 | Quiet package runner between Flats shafts and Grid roofs. | Cargo, Stealth, Wired |
| Netcaster / Snare-Drone / capture frame | Ground (drone) | Light | 2 | Restricted | 2,800 | 3 | Foam / monofil net — take alive, not apart. | Nonlethal, Capture, Wired |
| Ripper / Breach-Drone / door-cracker | Ground (drone) | Light | 3 | Military | 11,000 | 4 | Charges, cutters, or shaped punch for hard portals. | Breach, Assault, Wired |
| Stinger / Gun-Drone / aerial weapons platform | Air (drone) | Vehicle (drone) | 3 | Military | 13,000 | 4 | Real hardpoint gunner — fleet's flying damage dealer. | Combat, Mount, Jump-In-Capable, Wired |
| Skulker / Anthro-Drone / humanoid infiltrator | Ground (drone) | Personal | 3 | Military | 14,000 | 4 | Passes as a body at distance; tools or a sidearm mount. | Anthro, Infiltrate, Jump-In-Capable, Wired |
| Hellkite / Strafe-Wing / gunship microframe | Air (drone) | Vehicle (drone) | 3 | Military | 15,500 | 4 | Twin light mounts, dive strafe; loud and hated in the Grid. | Combat, Mount, Jump-In-Capable, Wired |
| Deep-Viper / Hunter Aquadron / wet hunter | Water (drone) | Vehicle (drone) | 3 | Military | 16,000 | 4 | Deeper hull, torpedo/spear mount, chase boats from below. | Aquatic, Combat, Jump-In-Capable, Wired |
| Pallbearer / Extraction Hauler / armored mule | Ground (drone) | Vehicle (drone) | 3 | Military | 12,000 | 4 | Armored cargo bay for downed runners; light defensive mount. | Cargo, Armor, Medic, Wired |
| Warhound / Combat Drone / heavy assault unit | Ground (drone) | Vehicle (drone) | 4 | Prototype | 40,000 | 5 | Apex walker/roller — heavy mounts, real armor, one-machine push. | Combat, Heavy, Jump-In-Capable, Wired |
| Iron Mantis / Siege-Frame / heavy assault walker-drone | Ground (drone) | Vehicle (drone) | 4 | Prototype | 45,000 | 5 | Limb-climber siege body; dual hardpoints; corridor nightmare. | Combat, Heavy, Climb, Jump-In-Capable, Wired |

**Count:** **25** published chassis (11 Cat 5E spine + 14 expansions).
 chassis (11 Cat 5E spine + 13 expansions).

### 5.2 Role quick-index

| Role | Chassis |
|---|---|
| Recon / spy | Fly, Skitter, Needle, Rotor, Crawler, Spotter |
| EW / decoy | Buzz, Choir-Box |
| Nonlethal / capture | Taser-Bee, Netcaster |
| Cargo / extract | Mule-Bot, Ghost-Courier, Pallbearer |
| Medic / repair | Medbot, Wrenchbot |
| Sentry | Guard-Dog, Nest |
| Aquatic | Barracuda, Deep-Viper |
| Breach / assault support | Ripper |
| Combat / gun | Stinger, Hellkite, Warhound, Iron Mantis |
| Anthro | Skulker |
...
Drones use a short **Integrity** track (Machines numeric pass will publish numbers). Until then, Directors may treat Street/Professional frames as fragile (a few solid hits) and Military/Prototype as sturdy.
...
| **Recovery** | Field Repair (Wrench signature / Repair skill) restores Integrity in the fight per class text. Between scenes: §Craft **Repair** Project or short bench time + ¥ parts (Director: ≈ 10–25% of chassis cost for a heavy rebuild) |
...
**Expendable tags (Needle, Buzz, etc.):** some Street micros are meant to die — Kamikaze / Decoy runs destroy the chassis by design (see Drone Jockey abilities).
