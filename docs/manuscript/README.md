...
**Status:** Official rulebook PDF **Version 0.4.0** (B88 + B97 hotlinks, 2026-09-19) — Foundry module **0.3.22** (independent); Michael-approved cover + L1/L2/L4/L5/Veil/Machines plates in-tree; journals still held  
...
Or `node tools/build-pdf.mjs` alone (runs assemble → inject → linkify → HTML/PDF). Output: `docs/manuscript/build/Ghostwire-Rulebook-0.4.0.pdf` (gitignored) and `ART-GAP-REPORT.md`. Journals stay held. Foundry module version stays **0.3.22**.
