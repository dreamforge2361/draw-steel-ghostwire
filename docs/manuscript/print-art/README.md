...
Local artwork for the **print PDF pipeline** (B88). Most binaries stay on the machine that builds the PDF — they are gitignored. This folder ships **stubs + a placement map**, plus three **Michael-approved** tracked plates (0.3.19):

- `cover/cover.webp` (optional `cover/cover.png`)
- `filler/voidmark.webp`
- `filler/hands-off.webp`
