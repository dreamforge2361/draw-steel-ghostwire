...
| # | Print title | Source |
|---|---|---|
| L1 | Setting Primer (Core Sourcebook harvest) | `lore:` `01-lore/L1-setting-primer.md` — CONTENT TBD — harvest from GHOSTWIRE Core Sourcebook |
| L2 | Peoples & World (Lore Book harvest) | `lore:` `01-lore/L2-peoples-and-world.md` — CONTENT TBD — harvest from GHOSTWIRE Lore Book V2 |
| L3 | Ossian Reach / Street Color (optional harvest) | `lore:` `01-lore/L3-ossian-reach-color.md` — CONTENT TBD — harvest from Core Sourcebook / Reach materials (fiction only; no rules) |
...
| 5 | Advancement & Echelons | `raw:` `24-advancement.md` *(print order earlier than filename)* |
