...
| File | Contents |
|---|---|
| `L1-setting-primer.md` | Cosmology, planes, Incursion, Magic, Corruption, hive, megacorps, Ten seats + profiles, **beneath/Chair/Kestrel/Resource Wars/Radiant Concord**, Wired, Space, Religion, Shadow Economy, Everyday Tech, **Vehicles & Transit** (2026-09-20 lock; Lane-Hopper POV token), timeline, present, themes |
