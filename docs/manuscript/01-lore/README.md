# `01-lore/` — PDF harvest (print manuscript)

Lore prose harvested for the Ghostwire print booklet. Artwork/lore from master PDFs carried as text; **no images embedded in Markdown**.
...
| File | Contents |
|---|---|
| `L1-setting-primer.md` | Cosmology, planes, Incursion, Magic, Corruption, hive, megacorps, Twelve seats + profiles (AEQ / LAZ 0.3.78), **beneath/Chair/Kestrel/Resource Wars/Radiant Concord**, Wired, Space, Religion, Shadow Economy, Everyday Tech, **Vehicles & Transit** (2026-09-20 lock; Lane-Hopper + Star-Chopper POV tokens), timeline, present, themes |
