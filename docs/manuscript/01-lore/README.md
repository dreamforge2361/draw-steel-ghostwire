...
| File | Contents |
|---|---|
| `L1-setting-primer.md` | Cosmology, planes, Incursion, Magic, Corruption, hive, megacorps, Twelve seats + profiles (AEQ / LAZ 0.3.79), **beneath/Chair/Kestrel/Resource Wars/Radiant Concord**, Wired, Space, Religion, Shadow Economy, Everyday Tech, **Vehicles & Transit** (2026-09-20 lock; Lane-Hopper + Star-Chopper POV tokens), timeline, present, themes |
