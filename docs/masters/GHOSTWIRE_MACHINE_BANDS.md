...
**Status:** Phase 4 v1 — 2026-09-17 · provisional numbers  
...
## 3. Item → band map (all 31 current vehicles-pack Items)

*Generated from the resolver in `scripts/machines.mjs`, so it matches what Deploy does.*
...
| Vehicle | `iron-giant` | Iron Giant | Ground | Vehicle–Heavy | 4 | `machine-vehicle-heavy` | standard | 200 | 8 walk |
