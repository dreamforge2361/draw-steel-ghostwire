...
| Star-Chopper / Long-Fork / tandem limiter hover-bike | Ground | Light | T5 | 5 | 700 | Street POV hover-bike — stretch-fork chopper, two seats, no wheels, limiter ~25–50 ft. Not the rifle named Chopper. | 1 |
| Bulldog / Heavy Hauler / street cargo van | Ground | Vehicle | T5 | 5 | 650 | Tires-on-deck cargo van — mass, not a hover POV. Placeholder art until Michael’s plate. | 1 |
