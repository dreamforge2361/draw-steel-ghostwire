...
| --- | --- | --- | --- | --- | --- | --- |
| `vessa-corran-dov` | Vessa Corran-Dov, "the Preacher of Ninth" (Street Priest, Corran) — *The Lamp on Ninth* | 20 | 22 | 800x800 | 1,464,868 B (1.40 MB) | `assets/pregens/vessa-corran-dov.png` |
| `kaes-vahn-estal` | Kaïs Vahn-Estal, "the Static Saint" (Elementalist, Elvani) — *Rain on the Glass Tier* | 28 | 32 | 800x800 | 1,589,102 B (1.52 MB) | `assets/pregens/kaes-vahn-estal.png` |
...
| `barak-voss-hallor` | Barak Voss-Hallor, "the Foreman" (Commander, Goliar) — *The Weight of the Word* | 46 | 52 | 800x800 | 1,479,945 B (1.41 MB) | `assets/pregens/barak-voss-hallor.png` |
| `wren-sable-corvin` | Wren Sable-Corvin, "the Kite" (Scout, Changer/Raven) — *The Long Sight* | 55 | 62 | 800x800 | 1,431,909 B (1.37 MB) | `assets/pregens/wren-sable-corvin.png` |
| `sabbat-vane` | Sabbat Vane, "the Dead Frequency" (Technomancer, Revenant) — *The Dead Frequency* | 64 | 72 | 800x800 | 1,511,574 B (1.44 MB) | `assets/pregens/sabbat-vane.png` |
| `vira-kellis-nade` | Vira Kellis-Nade, "the Warren-Wire" (Wrench, Changer/Rat) — *Nine Ways Out* | 75 | 84 | 800x800 | 1,442,122 B (1.38 MB) | `assets/pregens/vira-kellis-nade.png` |
| `kessic-draye` | Kessic Draye, "Null" (Hacker, Mutant) — *Turn Their Own Guns Around* | 87 | 97 | 800x800 | 1,482,726 B (1.41 MB) | `assets/pregens/kessic-draye.png` |
